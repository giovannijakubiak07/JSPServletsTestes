...
//                    element.click();
    ...
    @Test
    public void testeCampo1() throws InterruptedException {
        ...
        element.click();
        element = driver.findElement(By.id("retorno"));
        element.click();
        
        boolean FOI = false;
        if("http://localhost:8080/65TES_GiovanniJakubiak_DouglasBussmann".equals(driver.getCurrentUrl())){
            FOI = true;
        }
        assertFalse(FOI);
    }    
